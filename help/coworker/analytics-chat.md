...
자세한 내용은 [동료 채팅 UI 안내서](https://experienceleague.adobe.com/ko/docs/cx-enterprise-coworker/content/chat/ui-guide)를 참조하십시오.
...
자세한 내용은 [사용 사례](https://experienceleague.adobe.com/ko/docs/cx-enterprise-coworker/content/chat/use-cases)를 참조하세요.
