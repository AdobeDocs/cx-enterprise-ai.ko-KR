...
![데이터 세트 유효성 검사 요청, Experience Platform 환경 선택기 및 제어 보내기 메시지를 표시하는 프롬프트 필드가 있는 AI Assistant 홈](./assets/validation/home.png)
...
![추론 완료, 유효성 검사 요약 및 필드 경로, 형식 및 유효한 값을 나열하는 필드 요약 테이블이 포함된 AI Assistant 응답](./assets/validation/answer.png)
...
![유효성 검사 설명 및 통계가 왼쪽에 있는 분할형 보기 및 유효한 값이 확장된 차트 시각화가 오른쪽에 있습니다.](./assets/validation/split-screen.png)
...
![관련 제안은 프롬프트 필드 위에 칩으로 표시되며, 데이터 집합에 있는 특정 필드의 유효성을 검사하기 위해 한 가지 제안을 선택했습니다.](./assets/validation/related-suggestion.png)
...
![차트 보기의 단일 필드에 대한 유효성 검사 결과 카드로, 유효성 도넛 차트와 확장된 보기의 표시 동작을 표시합니다.](./assets/validation/single-field.png)
...
![자세한 필드 수준 유효성 검사 통계 및 차트 시각화를 보여주는 확장된 보기입니다.](./assets/validation/expanded-view.png)
