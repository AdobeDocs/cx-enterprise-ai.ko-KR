...
>[!IMPORTANT]
>
>[!DNL Microsoft 365 Copilot]용 Adobe Marketing Agent은 현재 Experience Platform Operational Insights, Customer Journey Analytics Data Insights, [Audience Agent](./audience.md) 및 [Journey Agent](./ajo-agent.md)을 지원합니다.
